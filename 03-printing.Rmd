...
a file. R allows you to achieve these tasks using a handful of printing
...
The code works and R executes the additions, but nothing is displayed on 
the consoloe. This is because the command `i + 1` forms part of an R expression,
that is, is within theTo be able to see the actual computations you should use `print()`
...
languages, this type of printing is known as _printf_ whish stands for 
...
options. The following table show the most common specifications:
