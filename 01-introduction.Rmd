...
[Chapter 2: Characters](#intro). If you are already familiar with the basics
...
I've also benefitted from my experience as a lecturer in the Statistics 
Department at the University of California, Berkeley. Much of the content 
in this book derives from the examples and problems I have created to teach
hundreds of students in the fall editions of Concepts in Computing with Data.
This book wouldn't have been possible without the feedback and capacity of
students to withstand my torturing them with data cleaning, wrangling and
string manipulations.

As always, many thanks to Jessica who patiently accepts my occupying of the
dinning table as my workbench.
